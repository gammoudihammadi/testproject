...
{
    public class OutputFormAccountingPage : PageBase
    {
        public OutputFormAccountingPage(IWebDriver webDriver, TestContext testContext) : base(webDriver, testContext)
        {
        }
        ...
        // Onglets
        public OutputFormItem ClickOnItems()
        {
        ...
        public double GetOutputFormGrossAmount(string writingType, string decimalSeparator)
        {
        ...
        public double GetOutputFormDetailAmount(string writingType, string decimalSeparator)
        {
            // Récupération du type de séparateur (, ou . selon les pays)
            CultureInfo ci = decimalSeparator.Equals(",") ? new CultureInfo("fr-FR") : new CultureInfo("en-US");
